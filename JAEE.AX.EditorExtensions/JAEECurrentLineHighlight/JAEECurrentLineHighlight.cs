...
{
    // JAEE: Based on extension by Tomas Restrepo @tomasrestrepo
    // https://github.com/tomasr/LineAdornments

    public class JAEECurrentLineHighlight
    {
        ...
        public JAEECurrentLineHighlight(IWpfTextView view, IClassificationFormatMap formatMap, IClassificationType formatType)
        {
            this.view = view;
